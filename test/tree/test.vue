...
export default {
  ...
  mounted(){
    this.menuList = routerList([
      {menuId: "1", name: "系统管理", url: "empty.html", open: true, icon: "iconfont icon-yonghuguanli"},
      {menuId: "1_1", parentId: "1", name: "用户管理", url: "empty.html", icon: "iconfont icon-yonghuguanli"},
...
//      {menuId: "1_1_1", parentId: "1_1", name: "使用记录", url: "empty.html", icon: "iconfont icon-yonghuguanli"},
      ...
      {menuId: "2_1", parentId: "2", name: "个人资料", url: "empty.html", icon: "iconfont icon-yonghuguanli"},
